...
<header>
    ...
    <div class="blog-post">
    <!-- <h1 class="blog-post-title">PUBG</h1> -->
    <div class="blog-post-body">
    <div class="img-wrapper">
      <img src="pictures/logo-rh-hitam.png" class="img-fluid">
    </div>
    <br/>
      <p class="blog-post-p " style="color:black">
      Ruang Harapan adalah markas dari kahf surabaya hijrah yg berlokasi di Jl Jarak 51b (eks Lokalisasi Dolly) gagasan awal pembentukan Ruang Harapan ini berawal dari keinginan untuk merubah daerah Dolly Surabaya menuju ke arah yang lebih baik
cara yang ditempuh untuk merubah kawasan Dolly tersebut melalui program kampung binaan Kahf surabayahijrah. Banyak program yang akan di jalankan kahf di Ruang harapan ini diantara lain : 
      <ul>
          <li>1. Kampung Kreatif</li>
          <li>2. Rumah Qur'an</li>
          <li>3. Perpustakaan Harapan</li>
          <li>4. Rumah Bekam</li>
          <li>5. One Day One Shodaqoh</li>
          <li>6. Bersih Bersih Masjid (BBM)</li>
          <li>7. Kahf Entrepreneurship</li>
      </ul>
      Diharapkan dari beberapa program yang kami buat, perlahan dapat merubah citra Dolly yang terkenal sebagai tempat prostitusi terbesar se Asia Tenggara dapat berubah menjadi Dolly Beriman.
      </p>
    </div>
    <br/>
    <br/>
    <ul>
      <li><h3 style="color:black">Other Program :</h3></li>
      <li><a href="pubg.php" style="color:#ff5e14">PUBG</a></li>
      <li><a href="foodbox.php" style="color:#ff5e14">Food Box</a></li>
      <li><a href="mbois.php" style="color:#ff5e14">MBOIS</a></li>
    </ul>
  </div>
