...
<div class="gallery-wrapper" style="background-color: rgb(13,13,13)">
  <br>
    ...
    <br>
    <div class="gallery">
      <h4 style="color: white, text-align:left">Event-2</h4>
        <a href="images/1.png" data-lightbox="mygallery" data-title="Bocchi desu"><img src="images/1.png" alt=""></a>
    ...
    <div class="gallery"><br>
        <h2 style="color: white">Event-2</h2>
