...
<header>
    ...
    <div class="img-wrapper">
      <img src="pictures/logo-food-box.png" class="img-fluid">
    </div>
    <br/>
      <p class="blog-post-p " style="color:black">
      Food Box adalah salah satu program sosial dari kahf surabayahijrah. Tujuan program ini adalah pembagian makanan di masjid - masjid terpencil yang ada di Surabaya. Sasaran program ini adalah saudara kita yang kurang mampu
kami sediakan satu etalase di satu masjid dan insyallah makanan akan kami kirim setiap hari Senin dan Kamis.
      </p>
