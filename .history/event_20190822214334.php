...
<body>
  <br>
  <h2 class="midtext" style="color: rgb(255, 204, 41);">Event</h2>
  <div class="polaroids">
    
    <div class="polaroid">
      <img src="kahf.jpg">
      <p>test<br>
        <strong>Narasumber :</strong> test <br>
        <strong>Lokasi :</strong> test <br>
        <strong>Waktu :</strong> test
    </p>
    </div>
    <div class="polaroid">
      <img src="1.png">
      <p>DHIFA<br>
        <strong>Narasumber :</strong> Hasna Nadhifah <br>
        <strong>Lokasi :</strong> Cedek Pocan <br>
        <strong>Waktu :</strong> Moleh Sekolah
      </p>
    </div>
    <div class="polaroid">
      <img src="https://picsum.photos/200/200?image=52">
    ...
    <div class="polaroid">
      <img src="https://picsum.photos/200/200?image=51">
      <p>DHIFA<br>
        <strong>Narasumber :</strong> Hasna Nadhifah <br>
        <strong>Lokasi :</strong> Cedek Pocan <br>
        <strong>Waktu :</strong> Moleh Sekolah
