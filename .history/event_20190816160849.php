...
<header>
    ...
    <html>
<body>
  <h2>Polaroid  Image-Gallery with caption - responsive</h2>
  <div class="polaroids">
    
    <div class="polaroid">
      <img src="https://picsum.photos/200/200?image=50">
      <p class="text-center">NGACENG</p><br><p><strong>Narasumber :</strong>Wisnu Lonthe <br>
