...
<header>
                ...
                <!-- Active itu buat halaman yang sedang dikunjungi -->
                  ...
                  <li class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu sm-menu">
                      <a class="dropdown-item" href="pubg">PUBG</a>
  ...
  <div class="blog-post">
    <h1 class="blog-post-title">Food Box</h1>
    <div class="blog-post-body">
    <div class="img-wrapper">
      <img src="pictures/logo-food-box-putih.png" class="img-fluid">
    </div>
    <br/>
      <p class="blog-post-p">
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Impedit magnam sunt id distinctio repellat odio aut iusto maxime, rerum perspiciatis veritatis perferendis fuga quasi deserunt ut, necessitatibus cum corporis harum voluptas dolorem vel repudiandae autem mollitia. Voluptates, ducimus tempore laboriosam.
  ...
  <div class="blog-post">
    <h1 class="blog-post-title">Ruang Harapan</h1>
    <div class="blog-post-body">
    <div class="img-wrapper">
      <img src="pictures/logo-rh-putih.png" class="img-fluid">
    </div>
    <br/>
      <p class="blog-post-p">
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Impedit magnam sunt id distinctio repellat odio aut iusto maxime, rerum perspiciatis veritatis perferendis fuga quasi deserunt ut, necessitatibus cum corporis harum voluptas dolorem vel repudiandae autem mollitia. Voluptates, ducimus tempore laboriosam.
  ...
  <div class="blog-post">
    <h1 class="blog-post-title">MBOIS</h1>
    <div class="blog-post-body">
    <div class="img-wrapper">
      <img src="pictures/PUBG.png" class="img-fluid">
    </div>
