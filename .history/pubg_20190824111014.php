...
<header>
    ...
    <ul>
      ...
      <li><a href="foodbox.php" style="color:cyan">Food Box</a></li>
      <li><a href="ruangharapan.php" style="color:cyan">Ruang Harapan</a></li>
      <li><a href="mbois.php" style="color:cyan">MBOIS</a></li>
    </ul>
  </div>
