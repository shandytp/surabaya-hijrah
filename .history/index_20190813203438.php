          ...
          <div class="row">
            ...
            <div class="col-md-4 col-sm-4">
              ...
              <ul class="follow-us clearfix">
                  <li><a href="#"><i class="fa fa-envelope" aria-hidden="true" style="font-size:36px"></i></a><a href="#"><pre>     surabayahijrah@kahf.com</pre></a></li>
                  <br>
                  <li><a href="#"><i class="fa fa-facebook" aria-hidden="true" style="font-size:36px"></i></a></li>
                  <br>
                  <li><a href="#"><i class="fa fa-instagram" aria-hidden="true" style="font-size:36px"></i></a><a href="#">&nbsp;&nbsp;&nbsp;&nbsp;@surabayahijrah</a></li>
            </ul>
            </div>
          </div>
        </div>
