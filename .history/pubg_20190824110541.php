...
<header>
    ...
    <ul>
      <li style="color:black"><h3>Other Program : </h3></li>
      <li style="color:black"><a href="foodbox.php">Food Box</a></li>
      <li style="color:black"><a href="ruangharapan.php">Ruang Harapan</a></li>
      <li style="color:black"><a href="mbois.php">MBOIS</a></li>
    </ul>
  </div>
