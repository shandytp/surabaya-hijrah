...
<header>
    ...
    <ul>
      ...
      <li><a href="foodbox.php" style="color:blue">Food Box</a></li>
      <li><a href="ruangharapan.php" style="color:blue">Ruang Harapan</a></li>
      <li><a href="mbois.php" style="color:blue">MBOIS</a></li>
    </ul>
  </div>
