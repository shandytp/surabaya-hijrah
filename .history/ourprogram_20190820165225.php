...
<header>
    ...
    <!-- Program -->
      <div class="content">
        <h1>asdasdsa</h1>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facere cumque error iusto alias omnis nostrum libero numquam ex, repellat fuga! Doloribus aliquam veritatis, et dolorem nostrum reiciendis delectus sint asperiores?</p>
        <br>
        <h2>araarar</h2>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde porro sit eos odit laborum officiis ab numquam perferendis, ex illum at harum quod qui consequuntur soluta sequi natus, voluptatem repellendus.</p>
        <div class="right-sidebar">
          <ul>iyo e tivi ne gk di setel
            <li>mantap</li>
            <li>slur</li>
            <li>iyoe</li>
          </ul>
