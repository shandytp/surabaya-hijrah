              ...
              <div class="collapse navbar-collapse " id="navbarSupportedContent">
                ...
                <!-- Active itu buat halaman yang sedang dikunjungi -->
                  ...
                  <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle navbar-nav" href="#" id="navbardrop" data-toggle="dropdown">
                    Our Program
                  </a>
...
<section class="our-webcoderskull padding-lg">
  <div class="container">
    ...
    <ul class="row">
      ...
      <li class="col-12 col-md-6 col-lg-3">
          <div class="cnt-block equal-hight" style="height: 300px;">
            <figure><a href="ourprogram.php"><img src="pictures/logo-food-box-putih.png" class="img-responsive" alt=""></figure>
            <h3>Food Box</a></h3>
          </div>
      </li>
      <li class="col-12 col-md-6 col-lg-3">
          <div class="cnt-block equal-hight" style="height: 300px;">
            <figure><a href="ourprogram.php"><img src="pictures/logo-rh-putih.png" class="img-responsive" alt=""></figure>
            <h3>Ruang Harapan</a></h3>
          </div>
       </li>
      <li class="col-12 col-md-6 col-lg-3">
          <div class="cnt-block equal-hight" style="height: 300px;">
            <figure><a href="ourprogram.php"><img src="2.jpg" class="img-responsive" alt=""></figure>
            <h3>Mbois</a></h3>
          </div>
      </li>
    </ul>
