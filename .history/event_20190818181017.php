...
<body>
  <br>
  <h2 class="midtext" style="color: rgb(255, 204, 41);">I LOVE DHIFA, ALL HAIL DHIFA</h2>
  <div class="polaroids">
    
    <div class="polaroid">
      <img src="kahf.jpg">
      <p>NGACENG<br>
        <strong>Narasumber :</strong> Wisnu Lonthe <br>
        <strong>Lokasi :</strong> ndek dolly <br>
        <strong>Waktu :</strong> pikiren dewe cok
    </p>
    </div>
    <div class="polaroid">
      <img src="1.png">
