...
<header>
  ...
  <div class="visi">
  <p class="text-center" style="color:white" >Komunitas dakwah kreatif pemuda sebagai gerbang pertama pemuda berhijrah </p>
    <p class="text-center" style="color:white"> sekaligus wadah yang dapat menginsiprasi yang berpedoman kepada Al-Quran dan As-Sunnah </p>
    <p class="text-center" style="color:white"> hingga terwujudnya Surabaya berperadaban</p>
</div>
...
<br>
  ...
  <br/>
  <div class="container">
    <h1 class="text-center">This Is Our Team</h1>
  <div class="row">
