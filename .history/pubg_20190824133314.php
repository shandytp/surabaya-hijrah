...
<header>
    ...
    <div class="img-wrapper">
      <img src="pictures/PUBG.png" class="img-fluid">
    </div>
    <br/>
      <p class="blog-post-p " style="color:black">
      PUBG adalah program unggulan kajian dari Kahf Surabaya Hijrah. kepanjangan PUBG adalah Pecinta qUran Bikin Gembira.
setiap kajian membahas 1 ayat dalam Al-Qur'an, agar bisa di kaji lebih mendalam dengan pembawaan yang santai tapi serius. Kajian ini terstruktur secara kurikulum yg dibuat oleh pembina kami Ustadz Heru Kusumahadi, Lc. 
      </p>
    </div>
    <br/>
    <br/>
    <ul>
      ...
      <li><a href="ruangharapan.php" style="color:#ff5e14">Ruang Harapan</a></li>
