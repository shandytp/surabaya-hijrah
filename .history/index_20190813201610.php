    ...
    <ul class="row">
      <li class="col-12 col-md-6 col-lg-3">
          <div class="cnt-block equal-hight" style="height: 300px;">
            <figure><img src="pictures/PUBG.png" class="img-responsive" alt=""  width="150px" height="150px"></figure>
            <h3><a href="#">Kajian</a></h3>
          </div>
      </li>
      <li class="col-12 col-md-6 col-lg-3">
          <div class="cnt-block equal-hight" style="height: 300px;">
            <figure><img src="pictures/logo-food-box.png" class="img-responsive" alt=""></figure>
            <h3><a href="#">Food Box</a></h3>
          </div>
      </li>
      <li class="col-12 col-md-6 col-lg-3">
          <div class="cnt-block equal-hight" style="height: 300px;">
            <figure><img src="pictures/logo-rh-putih.png" class="img-responsive" alt="" width="150" height="180"></figure>
            <h3><a href="#">Ruang Harapan</a></h3>
          </div>
       </li>
      <li class="col-12 col-md-6 col-lg-3">
          <div class="cnt-block equal-hight" style="height: 300px;">
