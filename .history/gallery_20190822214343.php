...
<div class="gallery-wrapper" style="background-color: rgb(13,13,13)">
  <br>
    <h1 class="text-center" style="color:rgb(255, 204, 41) ">Gallery</h1>
    <br>
    <div class="gallery">
      <h4 style="color: white">Event-2</h4>
        <a href="images/1.png" data-lightbox="event-1" data-title="Bocchi desu"><img src="images/1.png" alt=""></a>
        <!-- <a href="images/2.jpg" data-lightbox="mygallery"><img class="img-fluid" src="images/2.jpg" alt=""></a> -->
        <!-- <a href="images/3.png" data-lightbox="mygallery"><img src="images/3.png" alt=""></a> -->
        <a href="images/4.jpg" data-lightbox="event-1"><img src="images/4.jpg" alt=""></a>
        <a href="images/5.jpg" data-lightbox="event-1"><img src="images/5.jpg" alt=""></a>
    </div>
    <div class="gallery"><br>
        <h4 style="color: white">Event-2</h4>
        <a href="images/1.png" data-lightbox="mygallery"><img src="images/1.png" alt=""></a>
