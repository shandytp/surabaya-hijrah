                ...
                <div class="row">
                    <div class="col-xl-12 text-center pb-3">
                        <div class="section-title service-title">
                            <h2 style="color: black">SURABAYA HIJRAH BLOG</h2>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis voluptates explicabo assumenda ducimus possimus perspiciatis pariatur beatae eligendi esse obcaecati sunt eveniet, unde repellendus asperiores odio aut corporis neque omnis!</p>
                        </div>
                    </div>
                </div>
                <div class="row">
