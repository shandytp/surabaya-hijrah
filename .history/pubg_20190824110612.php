...
<header>
    ...
    <ul>
      ...
      <li><a href="foodbox.php" style="color:black">Food Box</a></li>
      <li><a href="ruangharapan.php" style="color:black">Ruang Harapan</a></li>
      <li><a href="mbois.php" style="color:black">MBOIS</a></li>
    </ul>
  </div>
