                ...
                <!-- Active itu buat halaman yang sedang dikunjungi -->
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu sm-menu">
                      <a class="dropdown-item text-warning" href="pubg.php">PUBG</a>
                      <a class="dropdown-item text-warning" href="foodbox.php">Food Box</a>
                      <a class="dropdown-item text-warning" href="ruangharapan.php">Ruang Harapan</a>
                      <a class="dropdown-item text-warning" href="mbois.php">MBOIS</a>
                    </div>
                  </li>
                  <li class="nav-item">
